...
from hbre_book.model.rankmixer.rankmixer import RankMixer
from hbre_book.model.rankmixer.preprocess import (
    VocabLookupTable,
    BookRecommendationIterableDataset,
)
from hbre_book.model.rankmixer.util import (
    move_to_device,
    tf_hash_bucket,
    BackgroundPrefetch,
    ensure_train_size_polars
)
from hbre_book.model.rankmixer.cache_io import CacheWriter, CacheReader, load_manifest
...
def main():
    ...
    with profiler.step("从训练样本统计构建词表和书籍表"):
            ...
            # ✅ 读取训练样本（一次性读取所有需要的列）
            sample_file = "train_samples_days_35_sample_pairwise_ratio_1v1v1_rankmixer.parquet"
    ...
    with profiler.step("构建训练/验证 DataLoader"):
        ...
        original_file = os.path.join(
            args.common_data_dir,
            "train_samples_days_35_sample_pairwise_ratio_1v1v1_rankmixer.parquet"
        )
        ...
        try:
            ...
            shuffled_path = os.path.join(args.common_data_dir, "train_samples_days_35_sample_pairwise_ratio_1v1v1_rankmixer_shuffled.parquet")
    ...
    with profiler.step("构建训练/验证 DataLoader"):
        ...
        try:
            ...
            shuffled_path = os.path.join(
                args.common_data_dir,
                "train_samples_days_35_sample_pairwise_ratio_1v1v1_rankmixer_shuffled.parquet"
            )
            df_shuffled.write_parquet(shuffled_path)
